          ...
          <div className="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted mb-0" style={{ fontSize: "14px" }}>
                Total {products?.length || 0} products in your store
              </p>
            </div>
          </div>
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className="position-relative">
                          <img
                            src={p.images?.[0] || "https://via.placeholder.com/60?text=No+Image"}
                            width="60"
                            height="60"
                            style={{
                              objectFit: "cover",
                      ...
                      <td className="px-4 py-3">
                        <Badge
                          style={{
                            ...
                            color: p.category === "Men" ? "#2196f3" :
                              p.category === "Women" ? "#e91e63" : "#9c27b0",
                            fontSize: "12px",
                            fontWeight: "600",
                            padding: "6px 12px",
                            borderRadius: "8px"
